...
if sys.platform=='darwin':
    app=BUNDLE(coll,name='ForgeCAD.app',icon=None,bundle_identifier='com.forgecad.workbench',info_plist={'CFBundleShortVersionString':'1.0.1','CFBundleVersion':'101','NSHighResolutionCapable':True,'LSMinimumSystemVersion':'13.0'})
